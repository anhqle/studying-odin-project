  ...
  describe Game do
    ...
    context "#initialize" do
      it "randomly selects a current player" do
        # this line creates a stub shuffle method, 
        # making sure that it always returns [frank, bob] 
        # when called on any array
    ...
    context "#game_over_message" do
      ...
      it "returns 'Game ends in a tie!' if board shows a draw" do
        game = Game.new([bob, frank])
        game.board.stub(:game_over) { :draw }
        expect(game.game_over_message). to eq "Game ends in a tie!"
      end
    end
